...
type MessageSerivice interface {
	Sse(ctx context.Context, request string) (r string, err error)
}

type MessageSeriviceClient struct {
	c thrift.TClient
}

func NewMessageSeriviceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *MessageSeriviceClient {
	return &MessageSeriviceClient{
		c: thrift.NewTStandardClient(f.GetProtocol(t), f.GetProtocol(t)),
	}
}

func NewMessageSeriviceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *MessageSeriviceClient {
	return &MessageSeriviceClient{
		c: thrift.NewTStandardClient(iprot, oprot),
	}
}

func NewMessageSeriviceClient(c thrift.TClient) *MessageSeriviceClient {
	return &MessageSeriviceClient{
		c: c,
	}
}

func (p *MessageSeriviceClient) Client_() thrift.TClient {
	return p.c
}

func (p *MessageSeriviceClient) Sse(ctx context.Context, request string) (r string, err error) {
	var _args MessageSeriviceSseArgs
	_args.Request = request
	var _result MessageSeriviceSseResult
...
type MessageSeriviceProcessor struct {
	processorMap map[string]thrift.TProcessorFunction
	handler      MessageSerivice
}

func (p *MessageSeriviceProcessor) AddToProcessorMap(key string, processor thrift.TProcessorFunction) {
	p.processorMap[key] = processor
}

func (p *MessageSeriviceProcessor) GetProcessorFunction(key string) (processor thrift.TProcessorFunction, ok bool) {
	processor, ok = p.processorMap[key]
	return processor, ok
}

func (p *MessageSeriviceProcessor) ProcessorMap() map[string]thrift.TProcessorFunction {
	return p.processorMap
}

func NewMessageSeriviceProcessor(handler MessageSerivice) *MessageSeriviceProcessor {
	self := &MessageSeriviceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self.AddToProcessorMap("Sse", &messageSeriviceProcessorSse{handler: handler})
	return self
}
func (p *MessageSeriviceProcessor) Process(ctx context.Context, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
type messageSeriviceProcessorSse struct {
	handler MessageSerivice
}

func (p *messageSeriviceProcessorSse) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := MessageSeriviceSseArgs{}
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := MessageSeriviceSseResult{}
	var retval string
...
type MessageSeriviceSseArgs struct {
	Request string `thrift:"request,1"`
}

func NewMessageSeriviceSseArgs() *MessageSeriviceSseArgs {
	return &MessageSeriviceSseArgs{}
}

func (p *MessageSeriviceSseArgs) InitDefault() {
}

func (p *MessageSeriviceSseArgs) GetRequest() (v string) {
	return p.Request
}

var fieldIDToName_MessageSeriviceSseArgs = map[int16]string{
	1: "request",
}

func (p *MessageSeriviceSseArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MessageSeriviceSseArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *MessageSeriviceSseArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *MessageSeriviceSseArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *MessageSeriviceSseArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *MessageSeriviceSseArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("MessageSeriviceSseArgs(%+v)", *p)

}

type MessageSeriviceSseResult struct {
	Success *string `thrift:"success,0,optional"`
}

func NewMessageSeriviceSseResult() *MessageSeriviceSseResult {
	return &MessageSeriviceSseResult{}
}

func (p *MessageSeriviceSseResult) InitDefault() {
}

var MessageSeriviceSseResult_Success_DEFAULT string

func (p *MessageSeriviceSseResult) GetSuccess() (v string) {
	if !p.IsSetSuccess() {
		return MessageSeriviceSseResult_Success_DEFAULT
	}
	return *p.Success
}

var fieldIDToName_MessageSeriviceSseResult = map[int16]string{
	0: "success",
}

func (p *MessageSeriviceSseResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *MessageSeriviceSseResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MessageSeriviceSseResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *MessageSeriviceSseResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *MessageSeriviceSseResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *MessageSeriviceSseResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *MessageSeriviceSseResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("MessageSeriviceSseResult(%+v)", *p)
